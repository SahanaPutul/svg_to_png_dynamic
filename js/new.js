...
//    }
    ...
    l = toggle.length, i;
for( i=0; i<l; i++) document.getElementById(toggle[i]).style.visibility = "visible";
...
//        document.getElementById("l_s1").style.visibility = "visible";
//        document.getElementById("l_s2").style.visibility = "visible";
//        document.getElementById("l_s3").style.visibility = "visible";
//        document.getElementById("l_s4").style.visibility = "visible";
        ...
        document.getElementById("l_s3").style.visibility = "hidden";
        document.getElementById("l_s4").style.visibility = "hidden";
        ...
        document.getElementById("l5").style.visibility = "hidden";
        document.getElementById("l_s1").style.visibility = "hidden";
        document.getElementById("l_s2").style.visibility = "hidden";
